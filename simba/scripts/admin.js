...
//             ${JSON.parse(element.img).map(val=>{return `<img src="https://png-uploads.vercel.app/uploads/${val}" alt="Картинка с поста">`})}
...
async function send(formData) {
    ...
    try {
        const response = await axios.post("https://png-uploads.vercel.app", formData, {
            headers: {
